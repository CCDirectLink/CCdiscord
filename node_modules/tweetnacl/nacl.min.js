! function(r) {
    ...
    function c(r, t, i, f, a) {
        ...
        if (a) {
            ...
            for (u = 0; u < 4; u++) l[5 * u] = l[5 * u] - e(f, 4 * u) | 0, l[6 + u] = l[6 + u] - e(t, 4 * u) | 0;
    ...
    function _(r, n, e, t, o) {
        var i;
        if (e < 32) return -1;
        for (v(r, 0, n, 0, e, t, o), b(r, 16, r, 32, e - 32, r), i = 0; i < 16; i++) r[i] = 0;
        return 0
    }
    ...
    r.lowlevel = {
            ...
            yr(r, n, e), cr(e, n);
            for (var t = new Uint8Array(Nr + r.length), o = new Uint8Array(t.length), i = 0; i < r.length; i++) t[i + Nr] = r[i];
            ...
            for (var n = new Uint8Array(Xr), e = 0; e < n.length; e++) n[e] = r[32 + e];
            return {
                publicKey: n,
                secretKey: new Uint8Array(r)
            }
            ...
            for (var n = new Uint8Array(Xr), e = new Uint8Array(Dr), t = 0; t < 32; t++) e[t] = r[t];
            return tr(n, e, !0), {
                publicKey: n,
                secretKey: e
            }
